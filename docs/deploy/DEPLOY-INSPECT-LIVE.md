...
| query | `sudo bash deploy/verify/verify-sentinel-x.sh` → `list_pods count >= 1` |
...
| 文件 | 作用 |
|------|------|
| [`agents/langgraph-integration/scripts/demo/inspect_langgraph_live_demo.py`](../agents/langgraph-integration/scripts/demo/inspect_langgraph_live_demo.py) | W2 主验收脚本 |
...
| [`docs/deploy/DEPLOY-LANGGRAPH-SYSTEMD.md`](DEPLOY-LANGGRAPH-SYSTEMD.md) | W1-2 |
| [`docs/deploy/DEPLOY-SYNC-CRON.md`](DEPLOY-SYNC-CRON.md) | W1-3 |
| [`docs/deploy/DEPLOY-MCP-KUBECONFIG.md`](DEPLOY-MCP-KUBECONFIG.md) | W1-4 |
